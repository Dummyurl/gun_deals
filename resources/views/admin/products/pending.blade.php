...
<div class="page-content">
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            <a class="btn btn-primary pull-right" href="{{ route('products.pending') }}">
                Pending Products
            </a>
            <a class="btn btn-default pull-right" style="margin-right: 5px;" href="{{ route('products.index') }}">
                Completed Products
            </a>
            <div class="clearfix"></div>    
            <div class="clearfix">&nbsp;</div>    
